...
INSERT INTO customer SELECT * FROM S3 (
    "uri" = "s3://redshift-downloads/TPC-H/2.18/100GB/customer/*",
    "format" = "csv",
...
INSERT INTO partsupp SELECT * FROM S3 (
        "uri" = "s3://redshift-downloads/TPC-H/2.18/100GB/partsupp/*",
        "format" = "csv",
        "s3.endpoint" = "https://s3.us-east-1.amazonaws.com",
        "column_separator" = "|"
);

INSERT INTO part SELECT * FROM S3 (
        "uri" = "s3://redshift-downloads/TPC-H/2.18/100GB/part/*",
        "format" = "csv",
        "s3.endpoint" = "https://s3.us-east-1.amazonaws.com",
        "column_separator" = "|"
);

INSERT INTO supplier SELECT * FROM S3 (
        "uri" = "s3://redshift-downloads/TPC-H/2.18/100GB/supplier/*",
        "format" = "csv",
        "s3.endpoint" = "https://s3.us-east-1.amazonaws.com",
        "column_separator" = "|"
);

INSERT INTO nation SELECT * FROM S3 (
        "uri" = "s3://redshift-downloads/TPC-H/2.18/100GB/nation/*",
        "format" = "csv",
        "s3.endpoint" = "https://s3.us-east-1.amazonaws.com",
        "column_separator" = "|"
);

INSERT INTO region SELECT * FROM S3 (
        "uri" = "s3://redshift-downloads/TPC-H/2.18/100GB/region/*",
        "format" = "csv",
        "s3.endpoint" = "https://s3.us-east-1.amazonaws.com",
        "column_separator" = "|"
);
